            ...
            <div class="container py-5">
                ...
                <div class="row g-1">
                    <div class="col-lg-3 col-6 ">
                        <div class="card">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img1.jpg')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                                    ...
                                    <h5 class="responsive-font og-price"><del>£199</del></h5>
                                    <h5 class="responsive-font discount"><em>64% Off</em></h5>
                                </div>
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img2.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img3.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"> <img src="{{url('assets/store/img4.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img5.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img6.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img7.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img8.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img9.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img10.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img11.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img12.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img13.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
                    ...
                    <div class="col-lg-3 col-6 ">
                        <div class="card ">
                            <a href="{{url('store/item')}}"><img src="{{url('assets/store/img14.jpg')}}"
                                    class="card-img-top zoom-eff" alt="..."></a>
                            <div class="card-body">
                                <p class="card-text responsive-font">Mid Size Caps Set of 2 for Adults</p>
                                <div class="card-title d-flex flex-row justify-content-around text-align">
