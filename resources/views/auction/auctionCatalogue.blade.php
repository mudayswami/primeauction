        ...
        <div class="container">
            ...
            <div class="alert alert-warning alert-dismissible fade show d-flex align-items-center" role="alert">
                ...
                <div class="col-lg-2 buying">
                    ...
                    <div class="regulations d-flex flex-column">
                        <a class=" " href="{{url('terms&condition/'.$auction['id'])}}">Terms & conditions</a>
                        <a class=" " href="{{url('important-info/'.$auction['id'])}}">Important Information</a>
            ...
            <div class="col-12 col-lg-3">
                ...
                <div class="col-12 col-lg-9">
                    @foreach ($lots as $key => $value)
                        <div class="auction-items" data-category="{{json_decode($value['category'], true)[0]}}" data-category-1="{{isset(json_decode($value['category'], true)[1]) ? json_decode($value['category'], true)[1] : ''}}">
                            <div class="row">
                                <div class="col-lg-2 ">
                                ...
                                <div class="col-lg-3 px-2 text-lg-center text-start  d-flex flex-column justify-content-evenly">
                                    <div>
                                        <div class="opening-bid d-none"><span class="light-header">Opening
                                                ...
                                                <a  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Other taxes: {{$auction['other_tax']}}">(?) Additional Fees</a>
                                    </div>
                                    <a href="{{url('bid').'/'.$value['id']}}">
                                        <a href="{{url('bid').'/'.$value['id']}}">
...
@push('scripts')
    ...
    const allItems = document.querySelectorAll('.auction-items');
